...
class KelasView(View):
    ...
    def get(self, request, pk=None, action=None):
        ...
        return render(request, 'pages/kelas.html', context)
    ...
    def put(self, request, pk=None, action=None):
        ...
        form = KelasForm(QueryDict(request.body), instance=id_)
        if form.is_valid():
            form.save()
    ...
    def get_create_form(self, pk=None):
        form = KelasForm()
        if pk:
            form = KelasForm(instance=self.get_object(pk))
        return render_to_string('partial/modal_form.html', {'form': form, 'data': 'kelas'})
    
    def get_del_modal(self, pk=None):
        id_ = pk
        if pk:
            id_ = self.get_object(pk)
        return render_to_string('partial/modal_del.html', {'data': id_, 'page': 'kelas'})

    def get_object(self, pk):
        return Kelas.objects.get(id=pk)
...
class SiswaView(View):
    ...
    def get(self, request, pk=None, action=None):
        ...
        if '/addsiswa' in path:
            context = {'nav': 'addsiswa', 'form': self.form}
            return render(request, 'pages/addsiswa.html', context)
        else:
            context = {'nav': 'siswa', 'data': Siswa.objects.all(),}
    ...
    def get_create_form(self, pk=None):
        ...
        return render_to_string('partial/modal_form.html', {'form': form, 'data': 'siswa'})
    
    def get_del_modal(self, pk=None):
        id_ = pk
        if pk:
            id_ = self.get_object(pk)
        return render_to_string('partial/modal_del.html', {'data': id_, 'page': 'siswa'})
